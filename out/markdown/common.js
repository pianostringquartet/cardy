...
var len__44527__auto___52783 = arguments.length;
var i__44528__auto___52784 = (0);
while(true){
if((i__44528__auto___52784 < len__44527__auto___52783)){
args__44534__auto__.push((arguments[i__44528__auto___52784]));

var G__52785 = (i__44528__auto___52784 + (1));
i__44528__auto___52784 = G__52785;
continue;
} else {
}
break;
...
return markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(argseq__44535__auto__);
});
...
markdown.common.freeze_string.cljs$lang$applyTo = (function (seq52782){
return markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq52782));
});
...
var G__52788 = cljs.core.reduce.call(null,((function (text,state,matches,temp__4655__auto__){
return (function (s,r){
...
return cljs.core.get.call(null,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__52786_SHARP_,p1__52786_SHARP_);
});})(text,state,matches,temp__4655__auto__))
);
});})(text,state,matches,temp__4655__auto__))
,text,matches);
var G__52789 = cljs.core.update.call(null,state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__4655__auto__){
return (function (p1__52787_SHARP_){
return cljs.core.apply.call(null,cljs.core.dissoc,p1__52787_SHARP_,matches);
});})(text,state,matches,temp__4655__auto__))
);
text = G__52788;
state = G__52789;
...
var vec__52792 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__52795 = transformer.call(null,clojure.string.join.call(null,buf),cur_state);
var s = cljs.core.nth.call(null,vec__52795,(0),null);
var new_state = cljs.core.nth.call(null,vec__52795,(1),null);
...
var new_buf = cljs.core.nth.call(null,vec__52792,(0),null);
var new_state = cljs.core.nth.call(null,vec__52792,(1),null);
var G__52799 = cljs.core.vec.call(null,cljs.core.concat.call(null,out,cljs.core.seq.call(null,open),new_buf,cljs.core.seq.call(null,close)));
var G__52800 = cljs.core.PersistentVector.EMPTY;
var G__52801 = cljs.core.rest.call(null,tokens);
var G__52802 = cljs.core.assoc.call(null,new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__52799;
buf = G__52800;
tokens = G__52801;
cur_state = G__52802;
...
var G__52803 = out;
var G__52804 = cljs.core.into.call(null,buf,cljs.core.first.call(null,tokens));
var G__52805 = cljs.core.rest.call(null,tokens);
var G__52806 = cur_state;
out = G__52803;
buf = G__52804;
tokens = G__52805;
cur_state = G__52806;
...
var G__52807 = out;
var G__52808 = buf;
var G__52809 = cljs.core.rest.call(null,tokens);
var G__52810 = cljs.core.assoc.call(null,cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__52807;
buf = G__52808;
tokens = G__52809;
cur_state = G__52810;
...
var G__52811 = cljs.core.into.call(null,out,cljs.core.first.call(null,tokens));
var G__52812 = buf;
var G__52813 = cljs.core.rest.call(null,tokens);
var G__52814 = cur_state;
out = G__52811;
buf = G__52812;
tokens = G__52813;
cur_state = G__52814;
...
var num_hashes = cljs.core.count.call(null,cljs.core.filter.call(null,(function (p1__52815_SHARP_){
return cljs.core.not_EQ_.call(null," ",p1__52815_SHARP_);
}),cljs.core.take_while.call(null,(function (p1__52816_SHARP_){
return (cljs.core._EQ_.call(null,"#",p1__52816_SHARP_)) || (cljs.core._EQ_.call(null," ",p1__52816_SHARP_));
