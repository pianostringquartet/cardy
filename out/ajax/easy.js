...
if(cljs.core.vector_QMARK_.call(null,format)){
return cljs.core.apply.call(null,cljs.core.vector,cljs.core.map.call(null,(function (p1__49404_SHARP_){
return ajax.easy.keyword_response_format_element.call(null,p1__49404_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__49405){
var map__49406 = p__49405;
var map__49406__$1 = ((((!((map__49406 == null)))?((((map__49406.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49406.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__49406):map__49406);
var handler = cljs.core.get.call(null,map__49406__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.call(null,map__49406__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.call(null,map__49406__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
var h = (function (){var or__43356__auto__ = handler;
...
var e = (function (){var or__43356__auto__ = error_handler;
if(cljs.core.truth_(or__43356__auto__)){
return or__43356__auto__;
} else {
...
return ((function (h,e,map__49406,map__49406__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__49408){
var vec__49409 = p__49408;
var ok = cljs.core.nth.call(null,vec__49409,(0),null);
var result = cljs.core.nth.call(null,vec__49409,(1),null);
...
;})(h,e,map__49406,map__49406__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__49412){
...
var opts = map__49413__$1;
var method = cljs.core.get.call(null,map__49413__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.call(null,map__49413__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.call(null,map__49413__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.call(null,map__49413__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.call(null,map__49413__$1,new cljs.core.Keyword(null,"body","body",-2049205669));

var needs_format = ((body == null)) && (cljs.core.not_EQ_.call(null,method,"GET"));
var rf = (cljs.core.truth_((function (){var or__43356__auto__ = format;
if(cljs.core.truth_(or__43356__auto__)){
return or__43356__auto__;
} else {
return needs_format;
