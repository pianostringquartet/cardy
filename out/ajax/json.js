...
if(cljs.core.truth_((function (){var and__43344__auto__ = prefix;
...
var ajax$json$make_json_response_format_$_json_response_format__1 = (function (p__49370){
var map__49371 = p__49370;
var map__49371__$1 = ((((!((map__49371 == null)))?((((map__49371.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49371.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__49371):map__49371);
var prefix = cljs.core.get.call(null,map__49371__$1,new cljs.core.Keyword(null,"prefix","prefix",-265908465));
var keywords_QMARK_ = cljs.core.get.call(null,map__49371__$1,new cljs.core.Keyword(null,"keywords?","keywords?",764949733));
var raw = cljs.core.get.call(null,map__49371__$1,new cljs.core.Keyword(null,"raw","raw",1604651272));
return ajax.interceptors.map__GT_ResponseFormat.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"read","read",1140058661),((function (map__49371,map__49371__$1,prefix,keywords_QMARK_,raw){
...
});})(map__49371,map__49371__$1,prefix,keywords_QMARK_,raw))
...
ajax$json$make_json_response_format_$_json_response_format = function(p__49370){
switch(arguments.length){
case 0:
return ajax$json$make_json_response_format_$_json_response_format__0.call(this);
case 1:
return ajax$json$make_json_response_format_$_json_response_format__1.call(this,p__49370);
}
