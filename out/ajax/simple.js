...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__49388){
...
var handler = cljs.core.get.call(null,map__49389__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__43356__auto__ = p1__49391_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__49392){
...
var request = map__49393__$1;
var interceptors = cljs.core.get.call(null,map__49393__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
...
var api = (function (){var or__43356__auto__ = new cljs.core.Keyword(null,"api","api",-899839580).cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__43356__auto__)){
return or__43356__auto__;
} else {
