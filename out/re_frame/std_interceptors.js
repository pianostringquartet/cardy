...
var vec__49918_49921 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_49922 = cljs.core.nth.call(null,vec__49918_49921,(0),null);
var only_after_49923 = cljs.core.nth.call(null,vec__49918_49921,(1),null);
var db_changed_QMARK__49924 = (!((only_before_49922 == null))) || (!((only_after_49923 == null)));
if(db_changed_QMARK__49924){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_49922);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_49923);
...
var map__49925 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__49925__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__49925__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__49927 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__49927__$1 = ((((!((map__49927 == null)))?((((map__49927.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49927.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__49927):map__49927);
var coeffects = map__49927__$1;
var event = cljs.core.get.call(null,map__49927__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__44527__auto___49930 = arguments.length;
var i__44528__auto___49931 = (0);
while(true){
if((i__44528__auto___49931 < len__44527__auto___49930)){
args__44534__auto__.push((arguments[i__44528__auto___49931]));

var G__49932 = (i__44528__auto___49931 + (1));
i__44528__auto___49931 = G__49932;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__44535__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq49929){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq49929));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__43356__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__44534__auto__ = [];
var len__44527__auto___49938 = arguments.length;
var i__44528__auto___49939 = (0);
while(true){
if((i__44528__auto___49939 < len__44527__auto___49938)){
args__44534__auto__.push((arguments[i__44528__auto___49939]));

var G__49940 = (i__44528__auto___49939 + (1));
i__44528__auto___49939 = G__49940;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__44535__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__49933_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__49934_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__49934_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__43344__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq49935){
var G__49936 = cljs.core.first.call(null,seq49935);
var seq49935__$1 = cljs.core.next.call(null,seq49935);
var G__49937 = cljs.core.first.call(null,seq49935__$1);
var seq49935__$2 = cljs.core.next.call(null,seq49935__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__49936,G__49937,seq49935__$2);
});
