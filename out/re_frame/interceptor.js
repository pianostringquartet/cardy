...
var len__44527__auto___49500 = arguments.length;
var i__44528__auto___49501 = (0);
while(true){
if((i__44528__auto___49501 < len__44527__auto___49500)){
args__44534__auto__.push((arguments[i__44528__auto___49501]));

var G__49502 = (i__44528__auto___49501 + (1));
i__44528__auto___49501 = G__49502;
continue;
} else {
}
break;
...
return re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic(argseq__44535__auto__);
});

re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic = (function (p__49497){
var map__49498 = p__49497;
var map__49498__$1 = ((((!((map__49498 == null)))?((((map__49498.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49498.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__49498):map__49498);
var m = map__49498__$1;
var id = cljs.core.get.call(null,map__49498__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var before = cljs.core.get.call(null,map__49498__$1,new cljs.core.Keyword(null,"before","before",-1633692388));
var after = cljs.core.get.call(null,map__49498__$1,new cljs.core.Keyword(null,"after","after",594996914));
if(re_frame.interop.debug_enabled_QMARK_){
var temp__4655__auto___49503 = cljs.core.seq.call(null,clojure.set.difference.call(null,cljs.core.set.call(null,cljs.core.keys.call(null,m)),re_frame.interceptor.mandatory_interceptor_keys));
if(temp__4655__auto___49503){
var unknown_keys_49504 = temp__4655__auto___49503;
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"error","error",-978969032),"re-frame: ->interceptor ",m," has unknown keys:",unknown_keys_49504);
} else {
}
} else {
}

return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__43356__auto__ = id;
...
re_frame.interceptor.__GT_interceptor.cljs$lang$applyTo = (function (seq49496){
return re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq49496));
});
...
var args__44534__auto__ = [];
var len__44527__auto___49515 = arguments.length;
var i__44528__auto___49516 = (0);
while(true){
if((i__44528__auto___49516 < len__44527__auto___49515)){
args__44534__auto__.push((arguments[i__44528__auto___49516]));

var G__49517 = (i__44528__auto___49516 + (1));
i__44528__auto___49516 = G__49517;
continue;
} else {
}
break;
...
return re_frame.interceptor.update_coeffect.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),argseq__44535__auto__);
});
...
re_frame.interceptor.update_coeffect.cljs$lang$applyTo = (function (seq49511){
var G__49512 = cljs.core.first.call(null,seq49511);
var seq49511__$1 = cljs.core.next.call(null,seq49511);
var G__49513 = cljs.core.first.call(null,seq49511__$1);
var seq49511__$2 = cljs.core.next.call(null,seq49511__$1);
var G__49514 = cljs.core.first.call(null,seq49511__$2);
var seq49511__$3 = cljs.core.next.call(null,seq49511__$2);
return re_frame.interceptor.update_coeffect.cljs$core$IFn$_invoke$arity$variadic(G__49512,G__49513,G__49514,seq49511__$3);
});
...
var G__49518 = re_frame.interceptor.invoke_interceptor_fn.call(null,cljs.core.assoc.call(null,context__$1,new cljs.core.Keyword(null,"queue","queue",1455835879),cljs.core.pop.call(null,queue),new cljs.core.Keyword(null,"stack","stack",-793405930),cljs.core.conj.call(null,stack,interceptor)),interceptor,direction);
context__$1 = G__49518;
continue;
}
break;
}
