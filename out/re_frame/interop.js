...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__48782 = cljs.core.instance_QMARK_;
var expr__48783 = reactive_val;
if(cljs.core.truth_(pred__48782.call(null,reagent.ratom.RAtom,expr__48783))){
return "ra";
} else {
if(cljs.core.truth_(pred__48782.call(null,reagent.ratom.RCursor,expr__48783))){
return "rc";
} else {
if(cljs.core.truth_(pred__48782.call(null,reagent.ratom.Reaction,expr__48783))){
return "rx";
} else {
if(cljs.core.truth_(pred__48782.call(null,reagent.ratom.Track,expr__48783))){
return "tr";
} else {
return "other";
}
